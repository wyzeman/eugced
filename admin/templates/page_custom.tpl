    ...
    <div id="main">
        <div class="header">
            ...
            {section name=s loop=$menu_items[$menu_position].sub_items}
                ...
                <a href="{$menu_items[$menu_position].sub_items[s].url|stripslashes}?initial"><b>{$menu_items[$menu_position].sub_items[s].label|stripslashes}</b></a>
                {else}
                    <a href="{$menu_items[$menu_position].sub_items[s].url|stripslashes}?initial">{$menu_items[$menu_position].sub_items[s].label|stripslashes}</a>
                {/if}
