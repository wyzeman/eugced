...
<div id="tabs_{$uniqid}">
    ...
    <ul>
        ...
        {section name=t loop=$tabs}
            <li><a href="#tabs_{$uniqid}_{$smarty.section.t.index}">{t}{$tabs[t].title|stripslashes}{/t}</a></li>
        {/section}
    </ul>
    ...
    {section name=t loop=$tabs}
        <div id="tabs_{$uniqid}_{$smarty.section.t.index}">
            {$tabs[t].content}
        </div>
    {/section}
